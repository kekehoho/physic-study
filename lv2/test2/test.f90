...
! integer(8) :: exec_t0, exec_t1, t_rate, count_max, t_diff  ! for exec time
    ...
    real(8),dimension(20,100) :: num,mu_total
    real(8),dimension(20,100) :: q,u,n,n_total
    real(8),dimension(20,100) :: q_total,u_total,w_total
    real(8),dimension(20,100) :: q_norm, u_norm
    real(8),dimension(20,100) :: n_s,n_s_total,n_s_all
 ...
 !  call system_clock(exec_t0, t_rate, count_max)
    ...
    write(fileName, '("test_scattering_times_"i3"_tau=10.csv")')i*5
 ...
 !        print'(f100.90,i5)',w,myrank
    ...
    if (abs(z_total).ge.depth)then
       do j = 1,20
          if(t .ge. (j-1)*5 .and. t .lt. j*5)then 
       do i = 1,100
          i_ = real(i)
